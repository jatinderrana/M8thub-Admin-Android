...
public class FeedsAdapter extends RecyclerView.Adapter<FeedsAdapter.ViewHolder> {
    ...
    public static String tag ="FeedsAdapter";
    List<GetbroadcastbyId.BroadcastGet> Response;
    int radiusArr[];
    Context context;
    ...
    public FeedsAdapter(Context context, List<GetbroadcastbyId.BroadcastGet> feeds) {
